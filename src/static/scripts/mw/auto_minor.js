...
console.log = function (text) {
	...
	if (text == "Wikiplus加载完毕") {
		window.autominor_oldDisplayQuickEditInterface =
			Wikiplus.displayQuickEditInterface;
		Wikiplus.displayQuickEditInterface = function () {
			window.autominor_oldDisplayQuickEditInterface.apply(
				this,
				arguments
			);
			document
				.querySelectorAll("#Wikiplus-Quickedit-MinorEdit")[0]
				.click();
		};
	}
};
